...
server = 'manirr.database.windows.net'
database = 'EaqrthQ'
username = 'mani631'
password = 'Mani@2103'
driver= '{ODBC Driver 13 for SQL Server}'
myHostname = "manirrc.redis.cache.windows.net"
myPassword = "nnCu6nszTi6jTujx54PIAfgWw4sIVqAPgRaYQszHRbU="

r = redis.Redis(host='manirrc.redis.cache.windows.net',
        port=6380, db=0, password='nnCu6nszTi6jTujx54PIAfgWw4sIVqAPgRaYQszHRbU=', ssl=True)
